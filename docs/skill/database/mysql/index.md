...
-- 修改用户名与命名
UPDATE `user` SET `username`='Brian',`password`='a12345678` WHERE id = 1
```
...
![img](https://img.Brian.cn/20201009150524563.png)
...
SELECT LOWER('Brian') --到小写
SELECT UPPER('Brian') --到大写
```
...
![image-20210102213536190](https://img.Brian.cn/image-20210102213536190.png)
