...
![](https://img.Brian.cn/image-20210527011655512.png)

## Docker 的命令

![](https://img.Brian.cn/v2-820aee2a33654099d87cdd2b7a1ce741_r.jpg)
...
![](https://img.Brian.cn/OIP.p3NmHHlewBvLwukFPGudFgHaFV.jpg)
...
```dockerfile
FROM cetnos
MAINTAINER Brian<911993023@qq.com>
...
2、docker login -u Brian

3、输入密码

```
[root@localhost ~]# docker login -u Brian
Password:
